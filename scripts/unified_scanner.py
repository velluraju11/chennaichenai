...
class HPTAUnifiedScanner:
    ...
    def __init__(self):
        ...
        self.root_dir = self.base_dir.parent  # Parent directory for main scripts
        self.scanners = {
            "ultra": {
    ...
    def run_scanner(self, scanner_name: str, target: str) -> Dict[str, Any]:
        ...
        # Handle relative paths (like ../ultra_malware_scanner_v3.py)
        if not script_path.exists() and ".." in scanner_info["script"]:
            script_path = self.base_dir / scanner_info["script"]
            script_path = script_path.resolve()  # Resolve relative path
